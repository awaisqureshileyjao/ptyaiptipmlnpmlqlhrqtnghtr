        ...
        {if $product}
            ...
            <div class="ty-product-block__img-wrapper" style="width: {*$settings.Thumbnails.product_details_thumbnail_width}px*}100%">
                {hook name="products:image_wrap"}
                    {if !$no_images}
                        <div class="ty-product-block__img hidden-desktop hidden-tablet cm-reload-{$product.product_id}" data-ca-previewer="true" id="product_images_{$product.product_id}_update">
