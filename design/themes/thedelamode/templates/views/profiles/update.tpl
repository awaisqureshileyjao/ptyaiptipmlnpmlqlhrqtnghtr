            ...
            {if $runtime.mode == "update"}
                {if !"ULTIMATE:FREE"|fn_allowed_for}
                    ...
                    <div id="content_usergroups">
                        ...
                        <pre>{$user_data.fields|print_r}</pre>
...
{literal}
<style type="text/css">
$('.ty-control-group.ty-profile-field__item.hidden label').addClass('hidden');
</style>
<script type="text/javascript">
$(document).ready(function(){
    $('.main-content-grid .ty-mainbox-container h1').html('Address Book');   
    $('.ty-control-group #password2').parent().addClass('hidden');
    $('.ty-control-group #password1').parent().addClass('hidden');
    $('.ty-control-group #elm_9').parent().addClass('hidden');
    $('.ty-control-group #elm_53').parent().addClass('hidden');
    $('.ty-control-group #elm_54').parent().parent().addClass('hidden');
   });
</script>
{/literal}
{/if}
...
<script type="text/javascript">
    $(document).ready(function(){
    $('.main-content-grid .ty-mainbox-container h1').html('Personal Information');    
    $('.ty-control-group #password2').parent().addClass('hidden');
    $('.ty-control-group #password1').parent().addClass('hidden');
    $('.ty-control-group #elm_19').parent().addClass('hidden');
    $('.ty-control-group #elm_23').parent().addClass('hidden');
    $('.ty-control-group #elm_52').parent().addClass('hidden');
    $('.ty-control-group #elm_27').parent().addClass('hidden');
    $('.ty-control-group #elm_29').parent().addClass('hidden');
    $('.ty-control-group #elm_25').parent().addClass('hidden');
    $('.ty-control-group #gdpr_agreements_profiles_update').parent().addClass('hidden');
    });
</script>
{/literal}
{/if}
...
{literal}
<script>
$("#elm_19").attr("disabled", "disabled"); 
$("#elm_52").attr("disabled", "disabled"); 
