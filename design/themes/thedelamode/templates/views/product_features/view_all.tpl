    ...
    <div class="ty-features-all__group ty-column6">
            {if $ranges}
                ...
                {foreach from=$ranges item="range"}                                       
                    <li class="ty-features-all__list-item"><a href="{"categories.view&category_id=`$category_id`?feature_hash=10-`$range.variant_id`"|fn_url}" 
                    class="ty-features-all__list-a">{$range.variant|fn_text_placeholders}</a></li>
