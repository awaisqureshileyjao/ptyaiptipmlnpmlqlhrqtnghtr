...
$config['db_name'] = 'oololivo321_cs_dlm';
$config['db_user'] = 'oololivo321_dlmcsct';
$config['db_password'] = 'N$jR!SL%Z(?M';
...
$config['http_host'] = 'dev.thedelamode.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'dev.thedelamode.com';
$config['https_path'] = '';
