	...
	RedactorPlugins.creativeorangeFontAwesome = function()
	{
		return {
			...
			init: function ()
			{
                ...
                this.button.setAwesome('creativeorangeFontAwesome', 'fa-flag-o');
			...
			getTemplate: function()
			{
				...
				function groupHtml(group, iconTitle) {
					...
					gridHtml = '<div class="mce-fontawesome-panel-accordion">';
						...
						gridHtml += '</div>';
					gridHtml += '</div>';
					gridHtml += '<p class="mce-fontawesome-search-noresults" style="display: none;">No icons matched your search.</p>';
				...
				var panelHtml = groupHtml('webApplicationIcons', 'Web Application')
							  + groupHtml('fileTypeIcons', 'File Type')
							  + groupHtml('spinnerIcons', 'Spinner')
							  + groupHtml('formControlIcons', 'Form Control')
							  + groupHtml('currencyIcons', 'Currency')
							  + groupHtml('textEditorIcons', 'Text Editor')
							  + groupHtml('directionalIcons', 'Directional')
							  + groupHtml('videoPlayerIcons', 'Video Player')
							  + groupHtml('brandIcons', 'Brand')
							  + groupHtml('medicalIcons', 'Medical')
							  + groupHtml('transportationIcons', 'Transportation')
							  + groupHtml('genderIcons', 'Gender')
							  + groupHtml('paymentIcons', 'Payment')
							  + groupHtml('chartIcons', 'Chart')
							  + groupHtml('handIcons', 'Hand');
				...
				+ '<div class="mce-fontawesome-panel">'
					+ '<div class="mce-container-body">'
						+ panelHtml
					+ '</div>'
				
					+ '<div class="mce-foot"><div class="mce-fontawesome-search-container">'
						+ '<input type="search" id="ath_iconSearchBox" placeholder="Search"><div class="mce-fontawesome-search-container-clear"><span class="fa fa-times-circle"></span>'
					+ '</div>'
			...
			show: function()
			{
				...
				var searchInput = document.querySelector("#ath_iconSearchBox");
				...
				function search() {
					...
					if (this.value.length) {
						...
						// Close all categories
						for (i = 0; i < categoryContentList.length; i++) {
							categoryContentList[i].style.height = '';
						}
					}
				}
				...
				function insertIcon() {
					...
					$('#redactor-modal footer button.redactor-modal-action-btn').click();
					console.log( id );
				}
			...
			insert: function()
			{
				var id = $(".js-mce-fontawesome-insert.active").data('id');
				if ($(".js-mce-fontawesome-insert.active").data('spin')) {
					id += ' fa-spin';
				}
				...
				var node = $('<span />').html('<span class="fa fa-' + id + '">&#65279</span>&nbsp;', false);
