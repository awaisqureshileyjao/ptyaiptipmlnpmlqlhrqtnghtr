    ...
    $.ceEditor('handlers', {
        ...
        run: function(elm, params) {
            ...
            if (typeof($.fn.redactor) == 'undefined') {
				...
				// * ThemeHills * //
				$.loadCss(['js/addons/ath_font_awesome/editors/redactor/plugins/fontawesome/fontawesome.min.css']);
				$.getScript('js/addons/ath_font_awesome/editors/redactor/plugins/fontawesome/fontawesome.js');
				// * ThemeHills * //
			...
			this.params.plugins = ['fontcolor', 'table','creativeorangeFontAwesome'];
			// * ThemeHills * //
