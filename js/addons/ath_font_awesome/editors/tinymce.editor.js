...
(function (_, $) {
    ...
    var editor = {
        ...
        params: {
			...
			// * ThemeHills * //
			content_css: 'js/addons/ath_font_awesome/use.fontawesome.css?470',
			// * ThemeHills * //
        ...
        run: function ($el, params) {
			...
			editor.params.toolbar = 'formatselect fontselect fontsizeselect bold italic underline forecolor backcolor | link image | numlist bullist indent outdent | alignleft aligncenter alignright | code | fontawesome';
			// * ThemeHills * //
            if (_.area == 'C') {
				// * ThemeHills * //
                ...
                editor.params.toolbar = 'formatselect fontselect fontsizeselect bold italic underline forecolor backcolor | numlist bullist indent outdent | alignleft aligncenter alignright | fontawesome';
				// * ThemeHills * //
            }
            ...
            if (!this.params) {
                this.params = {
                    ...
                    toolbar: 'formatselect fontselect fontsizeselect bold italic underline forecolor backcolor | link image | numlist bullist indent outdent | alignleft aligncenter alignright | code | fontawesome',
					// * ThemeHills * //
                    resize: true,
                    theme : 'modern',
                    language: lang,
