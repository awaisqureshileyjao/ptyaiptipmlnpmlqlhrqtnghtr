...
{
if (AREA === 'C' && !empty($params['variants_selected_only'])) {
$device = fn_abt__ut2_get_device_type();
if (Registry::get('settings.abt__ut2.products.view.show_brand_logo.' . $device) === 'Y' && Registry::get('settings.abt__ut2.products.view.brand_link_behavior') === 'to_category_with_filter') {
