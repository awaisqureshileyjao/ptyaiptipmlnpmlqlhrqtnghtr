...
function fn_ab__dotd_show_label_in_products_lists($applied_promotions)
{
if (empty($applied_promotions)) {
return false;
}
static $denied_promotions_ids = null;
if ($denied_promotions_ids === null) {
$denied_promotions_ids = db_get_fields('SELECT promotion_id FROM ?:ab__dotd WHERE show_label_in_products_lists = ?s', 'N');
}
foreach ($applied_promotions as $promotion_id => $data) {
if (!in_array($promotion_id, $denied_promotions_ids)) {
return true;
}
}
return false;
