...
return array(CONTROLLER_STATUS_OK, 'categories.update?item_id=' . $_REQUEST['item_id'] . '&category_id=' . $_REQUEST['category_id'] . '&selected_section=ab__pfe_feature_names');
}
return;
}
if ($mode == 'update') {
...
if (!empty($_REQUEST['item_id'])) {
fn_ab__pfe_delete_feature_names(array($_REQUEST['item_id']));
return array(CONTROLLER_STATUS_OK, $_REQUEST['return_url'] . '&selected_section=ab__pfe_feature_names');
}
}
